...
// display pagination
echo "<p><a href='calculateMargin.php'>View All</a> | <b>View Page:</b> ";
...
{
echo "<a href='calculateMarginByPage.php?page=$i'>$i</a> ";
}
}
echo "</p>";
...
echo '<td>' . $row[2] . '</td>';
echo '<td>' . $row[3] . '</td>';
echo '<td><a href="calculate.php?Product_ID=' . $row[0] . '">Margin</a></td>';
echo "</tr>";
}
