...
// display pagination
echo "<p><a href='calculateMarginSupervisor.php'>View All</a> | <b>View Page:</b> ";
...
{
echo "<a href='calculateMarginByPageSupervisor.php?page=$i'>$i</a> ";
}
}
echo "</p>";
...
echo '<td>' . $row[2] . '</td>';
echo '<td>' . $row[3] . '</td>';
echo '<td><a href="calculateSupervisor.php?Product_ID=' . $row[0] . '">Margin</a></td>';
echo "</tr>";
}
