...
// check if the 'page' variable is set in the URL (ex: view-paginated2PageSupervisor.php?page=1)
...
// display pagination
echo "<p><a href='view2PageSupervisor.php'>View All</a> | <b>View Page:</b> ";
...
{
echo "<a href='view-paginated2PageSupervisor.php?page=$i'>$i</a> ";
}
}
echo "</p>";
