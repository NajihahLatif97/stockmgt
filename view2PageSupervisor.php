...
<body>
<div align="right">
<p><form name="search" method="post" action="search-executePageSupervisor.php">
...
<a href='calculateMarginSupervisor.php'>Calculate increasing margin for product in percantage (%)</a>
</p>
</div>

<h1>Log</h1>

<p><b>View All</b> | <a href="view-paginated2PageSupervisor.php">View Paginated</a></p>
...
// set table headers
echo "<tr><th>ID</th><th>Date</th><th>Product ID</th><th>Flow Type</th><th>Type</th><th>Type ID</th><th>Supplier ID</th><th>Quantity</th><th>Location</th><th>Unit Buy (RM)</th><th>Unit Sell (RM)</th></tr>";
