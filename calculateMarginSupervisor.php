...
<p><b>View All</b> | <a href="calculateMarginByPageSupervisor.php">View Paginated</a></p>
...
echo "<td><a href='calculateSupervisor.php?Product_ID=" . $row->Product_ID . "'>Margin</a></td>";
echo "</tr>";
}
