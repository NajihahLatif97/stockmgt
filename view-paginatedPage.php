...
// check if the 'page' variable is set in the URL (ex: view-paginatedPage.php?page=1)
...
// display pagination
echo "<p><a href='viewPage.php'>View All</a> | <b>View Page:</b> ";
...
{
echo "<a href='view-paginatedPage.php?page=$i'>$i</a> ";
}
}
echo "</p>";
...
echo '<td>' . $row[7] . '</td>';
echo '<td>' . $row[8] . '</td>';
echo '<td><a href="recordsPage.php?Product_ID=' . $row[0] . '">Edit</a></td>';
echo '<td><a href="deletePage.php?Product_ID=' . $row[0] . '" onclick="return confirm();">Delete</a></td>';
echo "</tr>";
}
