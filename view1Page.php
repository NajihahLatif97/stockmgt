...
<p><b>View All</b> | <a href="view-paginated1Page.php">View Paginated</a></p>
...
echo "<td><a href='delete1Page.php?Supplier_ID=" . $row->Supplier_ID . "' onclick='return confirm();'>Delete</a></td>";
echo "</tr>";
}
