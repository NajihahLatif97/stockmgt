...
// check if the 'page' variable is set in the URL (ex: view-paginated2Page.php?page=1)
...
// display pagination
echo "<p><a href='view2Page.php'>View All</a> | <b>View Page:</b> ";
...
{
echo "<a href='view-paginated2Page.php?page=$i'>$i</a> ";
}
}
echo "</p>";
...
echo '<td>' . $row[9] . '</td>';
echo '<td>' . $row[10] . '</td>';
echo '<td><a href="records2Page.php?Log_ID=' . $row[0] . '">Edit</a></td>';
echo '<td><a href="delete2Page.php?Log_ID=' . $row[0] . '" onclick="return confirm();">Delete</a></td>';
echo "</tr>";
}
