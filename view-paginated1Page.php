...
// check if the 'page' variable is set in the URL (ex: view-paginated1Page.php?page=1)
...
// display pagination
echo "<p><a href='view1Page.php'>View All</a> | <b>View Page:</b> ";
...
{
echo "<a href='view-paginated1Page.php?page=$i'>$i</a> ";
}
}
echo "</p>";
...
echo "<tr> <th>ID</th> <th>Supplier Name</th> <th>Email</th> <th>Address</th> <th>Code</th> <th>City</th> <th>Person In Charge</th> <th>Phone No.</th>  <th></th></tr>";
...
echo '<td>' . $row[6] . '</td>';
echo '<td>' . $row[7] . '</td>';
echo '<td><a href="delete1Page.php?Supplier_ID=' . $row[0] . '" onclick="return confirm();">Delete</a></td>';
echo "</tr>";
}
...
<a href="records1Page.php">Add New Supplier</a>
<p></p>
</nav>
</body>
